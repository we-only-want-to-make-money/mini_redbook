...
(function() {
    function n(n) {
        ...
        return function(r, e, u, i) {
            e = g(e, i, 4);
            var o = !S(r) && d.keys(r), a = (o || r).length, c = n > 0 ? 0 : a - 1;
    ...
    }, x = Math.pow(2, 53) - 1, S = function(n) {
    ...
    d.each = d.forEach = function(n, t, r) {
        t = g(t, r);
        var e, u;
        if (S(n)) for (e = 0, u = n.length; e < u; e++) t(n[e], e, n); else {
            var i = d.keys(n);
        ...
        t = m(t, r);
        for (var e = !S(n) && d.keys(n), u = (e || n).length, i = Array(u), o = 0; o < u; o++) {
            var a = e ? e[o] : o;
            i[o] = t(n[a], a, n);
        }
        return i;
        ...
        var e;
        if (void 0 !== (e = S(n) ? d.findIndex(n, t, r) : d.findKey(n, t, r)) && -1 !== e) return n[e];
        ...
        t = m(t, r);
        for (var e = !S(n) && d.keys(n), u = (e || n).length, i = 0; i < u; i++) {
            var o = e ? e[i] : i;
        ...
        return S(n) || (n = d.values(n)), d.indexOf(n, t, "number" == typeof r && r) >= 0;
        ...
        var e, u, i = -1 / 0, o = -1 / 0;
        if (null == t && null != n) for (var a = 0, c = (n = S(n) ? n : d.values(n)).length; a < c; a++) (e = n[a]) > i && (i = e); else t = m(t, r), 
        ...
        for (var t, r = S(n) ? n : d.values(n), e = r.length, u = Array(e), i = 0; i < e; i++) (t = d.random(0, i)) !== i && (u[i] = u[t]), 
        u[t] = r[i];
        return u;
    }, d.sample = function(n, t, r) {
        return null == t || r ? (S(n) || (n = d.values(n)), n[d.random(n.length - 1)]) : d.shuffle(n).slice(0, Math.max(0, t));
    ...
    d.groupBy = _(function(n, t, r) {
        d.has(n, r) ? n[r].push(t) : n[r] = [ t ];
    }), d.indexBy = _(function(n, t, r) {
        n[r] = t;
    }), d.countBy = _(function(n, t, r) {
        d.has(n, r) ? n[r]++ : n[r] = 1;
    }), d.toArray = function(n) {
        return n ? d.isArray(n) ? c.call(n) : S(n) ? d.map(n, d.identity) : d.values(n) : [];
    }, d.size = function(n) {
        return null == n ? 0 : S(n) ? n.length : d.keys(n).length;
    ...
    var w = function n(t, r, e, u) {
        for (var i = [], o = 0, a = u || 0, c = t && t.length; a < c; a++) {
            var f = t[a];
            if (S(f) && (d.isArray(f) || d.isArguments(f))) {
                r || (f = n(f, r, e));
                var l = 0, s = f.length;
    ...
    d.keys = function(n) {
        ...
        var e, u, i = {}, o = n;
        if (null == o) return i;
        d.isFunction(t) ? (u = d.allKeys(o), e = g(t, r)) : (u = w(arguments, !1, !1, 1), 
        e = function(n, t, r) {
            return t in r;
        }, o = Object(o));
        ...
        if (d.isFunction(t)) t = d.negate(t); else {
            var e = d.map(w(arguments, !1, !1, 1), String);
            t = function(n, t) {
    ...
    var F = function n(t, r, u, i) {
        if (t === r) return 0 !== t || 1 / t == 1 / r;
        if (null == t || null == r) return t === r;
        t instanceof d && (t = t._wrapped), r instanceof d && (r = r._wrapped);
        var o = f.call(t);
        ...
        if (!a) {
            if ("object" != (void 0 === t ? "undefined" : e(t)) || "object" != (void 0 === r ? "undefined" : e(r))) return !1;
            var c = t.constructor, l = r.constructor;
            if (c !== l && !(d.isFunction(c) && c instanceof c && d.isFunction(l) && l instanceof l) && "constructor" in t && "constructor" in r) return !1;
        }
        u = u || [], i = i || [];
        for (var s = u.length; s--; ) if (u[s] === t) return i[s] === r;
        if (u.push(t), i.push(r), a) {
            if ((s = t.length) !== r.length) return !1;
            for (;s--; ) if (!n(t[s], r[s], u, i)) return !1;
        } else {
            var p, h = d.keys(t);
            if (s = h.length, d.keys(r).length !== s) return !1;
            for (;s--; ) if (p = h[s], !d.has(r, p) || !n(t[p], r[p], u, i)) return !1;
        }
    ...
    d.isEqual = function(n, t) {
        ...
        return null == n || (S(n) && (d.isArray(n) || d.isString(n) || d.isArguments(n)) ? 0 === n.length : 0 === d.keys(n).length);
    ...
    }), "function" != typeof /./ && "object" != ("undefined" == typeof Int8Array ? "undefined" : e(Int8Array)) && (d.isFunction = function(n) {
